...
# SET WORKSAPCE                                                               #
###############################################################################
FolderRoot = "~/Exhaustive-MaF1-ECC"
...
###############################################################################
FolderJob = paste(FolderRoot, "/EMaC-Jobs", sep = "")
...
while (i <= n) {
  ...
  # job name
  job_name = paste("EMaC-", dataset$Name, sep = "")

  # directory name
  folder_name = paste("/scratch/", job_name, sep = "")

  # Confi File Name
  file_name = paste("EMaC-", dataset$Name, ".csv", sep="")
  ...
  write("echo =================================================",
        file = output.file, append = TRUE)
  write("echo SBATCH: RUNNING EXHAUSTIVE MACRO F1 CLUS PARTITIONS",
        file = output.file, append = TRUE)
  write("echo =================================================",
        file = output.file, append = TRUE)
  ...
  str7 = paste("Rscript /home/u704616/Exhaustive-MaF1-Clus/R/exhaustive.R \"/home/u704616/EMaC-Config-Files/",
               file_name, "\"", sep = "")
