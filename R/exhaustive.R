cat("\n\n################################################################")
cat("\n# START EXECUTE EXHAUSTIVE MACRO F1 CLUS                         #")
cat("\n##################################################################\n\n")
...
#config_file = "/home/cissa/Exhaustive-MaF1-Clus/EMaC-Config-Files/EMaC-GpositiveGO.csv"
...
cat("\n###################################################################")
cat("\n# END OF EXHAUSTIVE PARTITIONS Macro-F1 CLUS. Thanks God!         #")
cat("\n###################################################################\n\n")
cat("\n\n\n\n")
