cat("\n\n################################################################################################")
cat("\n# START EXECUTE EXHAUSTIVE MACRO F1                                                              #")
cat("\n##################################################################################################\n\n") 
...
#destino = paste("cloud:elaine/[2021]ResultadosExperimentos/Exhaustive-MacroF1/Train-Test/Macro-F1/", dataset_name, "/Validation/", sep="")
...
#destino = paste("cloud:elaine/[2021]ResultadosExperimentos/Exhaustive-MacroF1/Train-Test/Macro-F1/", dataset_name, "/Test/", sep="")
...
#destino = paste("cloud:elaine/[2021]ResultadosExperimentos/Exhaustive-MacroF1/Train-Test/Macro-F1/", dataset_name, sep="")
#comando = paste("rclone -v copy ", diretorios$folderReportsDataset, " ", destino, sep="")
#print(system(comando))
