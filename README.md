...
This code is part of my doctoral research at PPG-CC/DC/UFSCar. The aim is build, validate and test all possible partitions for multilabel classification using Ensemble of Classificer Chain.

## How to cite 
@misc{Gatto2021, author = {Gatto, E. C.}, title = {Exhaustive Macro-F1 Partitions for Multilabel Classification with Clus}, year = {2022}, publisher = {GitHub}, journal = {GitHub repository}, howpublished = {\url{https://github.com/cissagatto/Exhaustive-MaF1-Clus}}}
...
| Partitions_Path | Absolute path to the folder where the partitions are stored               |
...
## RUN
To run the code, open the terminal, enter the */Exhaustive-MaF1-Clus/R/* folder, and type

```
Rscript exhaustive.R [absolute_path_to_config_file]
```

Example:

```
Rscript exhaustive.R "~/Exhaustive-MaF1-Clus/EMaC-Config-Files/EMaC-GpositiveGO.csv"
```
