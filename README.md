...
## How to cite 
@misc{Gatto2021, author = {Gatto, E. C.}, title = {Exhaustive Partition Experiment with Macro-F1}, year = {2021}, publisher = {GitHub}, journal = {GitHub repository}, howpublished = {\url{https://github.com/cissagatto/Exhaustive-MaF1-Clus}}}
...
Enter the folder "~/Exhaustive-MaF1-Clus/R"  in a terminal and type:
